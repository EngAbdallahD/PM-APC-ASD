 ...
 * Save the code: Copy all the Python code provided below into a file named pm_system.py.
 * Place CSV files: Ensure your HLP.csv, SCREEN.csv, and COMPACTION.csv files are in the same directory as pm_system.py.
 * Open a terminal or command prompt.
 * Navigate to the directory where you saved pm_system.py.
 * Run the script using the command: python pm_system.py
